...
;define("ember-test/initializers/ember-data", ["exports", "ember-data/setup-container"], function (_exports, _setupContainer) {
  "use strict";
...
;
          if (!runningTests) {
            require("ember-test/app")["default"].create({"name":"ember-test","version":"0.0.0+93e935be"});
          }
